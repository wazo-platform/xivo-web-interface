...
$inputhidden['id'] = 'it-phonefunckey-extenfeatures-paging-typeval';

$inputtxt = $inputhidden;
$inputtxt['size'] = 20;
$inputtxt['name'] = 'phonefunckey-extenfeatures-paging-suggest';
$inputtxt['id'] = 'it-phonefunckey-extenfeatures-paging-suggest';
...
if($fkdata['ex'] === false):
	...
	if($fkdata['type'] === 'extenfeatures-paging'):
