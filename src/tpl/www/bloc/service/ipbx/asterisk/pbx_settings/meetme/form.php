...
<uib-tabset active="active">
	...
	<uib-tab index="1" heading="<?=$this->bbf('smenu_administrator');?>">
		<?php
	...
	<uib-tab index="2" heading="<?=$this->bbf('smenu_user');?>">
		<?php
	...
	<uib-tab index="3" heading="<?=$this->bbf('smenu_email');?>">
		<?php
	...
	<uib-tab index="4" heading="<?=$this->bbf('smenu_guest');?>">
		<?php
