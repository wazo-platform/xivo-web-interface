...
<div class="b-infos b-form">
	...
	<div class="sb-content">
		...
		<uib-tabset active="active">
			...
			<uib-tab index="1" heading="<?=$this->bbf('smenu_voicemenu');?>">
				<?php
			...
			<uib-tab index="2" heading="<?=$this->bbf('smenu_email');?>">
				<?php
			...
			<uib-tab index="3" heading="<?=$this->bbf('smenu_pager');?>">
				<?php
			...
			<uib-tab index="5" heading="<?=$this->bbf('smenu_adsi');?>">
				<?php
			...
			<uib-tab index="6" heading="<?=$this->bbf('smenu_advanced');?>">
				<?php
