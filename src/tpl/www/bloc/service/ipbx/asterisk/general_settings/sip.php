	...
	<div class="sb-content">
		<form class="form-horizontal" action="#" method="post" accept-charset="utf-8" onsubmit="dwho.form.select('it-localnet'); dwho.form.select('it-codec');">
			...
			<uib-tabset active="active">
				<uib-tab index="0" heading="<?=$this->bbf('smenu_general');?>">
					<?php
						echo	$form->text(array('desc'	=> $this->bbf('fm_bindport'),
							...
							$form->select(array('desc'	=> $this->bbf('fm_autocreatepeer'),
												'name'		=> 'autocreatepeer',
												'labelid'		=> 'autocreatepeer',
											'key'			=> false,
											'bbf'			=> 'fm_autocreatepeer-opt',
											'bbfopt'		=> array('argmode' => 'paramvalue'),
											'help'		=> $this->bbf('hlp_fm_autocreatepeer'),
											'required'	=> false,
											'selected'	=> $this->get_var('info','autocreatepeer','var_val'),
											'default'		=> $element['autocreatepeer']['default']),
									$element['autocreatepeer']['value']),
				...
				<uib-tab index="1" heading="<?=$this->bbf('smenu_network');?>">
					<?php
				...
				<uib-tab index="2" heading="<?=$this->bbf('smenu_security');?>">
					<?php
				...
				<uib-tab index="3" heading="<?=$this->bbf('smenu_signalling');?>">
					<?php
				...
				<uib-tab index="4" heading="<?=$this->bbf('smenu_t38');?>">
					<?php
				...
				<uib-tab index="5" heading="<?=$this->bbf('smenu_jitterbuffer');?>">
					<?php
				...
				<uib-tab index="6" heading="<?=$this->bbf('smenu_default');?>">
					<?php
				...
				<uib-tab index="7" heading="<?=$this->bbf('smenu_realtime');?>">
					<?php
				...
				<uib-tab index="8" heading="<?=$this->bbf('smenu_internals');?>">
					<?php
				...
				<uib-tab index="9" heading="<?=$this->bbf('smenu_authentication');?>">
					<?php
						$type = 'disp';
