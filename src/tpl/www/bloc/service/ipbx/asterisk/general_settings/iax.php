	...
	<div class="sb-content">
		<form class="form-horizontal" action="#" method="post" accept-charset="utf-8" onsubmit="dwho.form.select('it-codec');">
			...
			<uib-tabset active="active">
				...
				<uib-tab index="1" heading="<?=$this->bbf('smenu_jitterbuffer');?>">
				...
				<uib-tab index="2" heading="<?=$this->bbf('smenu_default');?>">
					<?php
				...
				<uib-tab index="3" heading="<?=$this->bbf('smenu_realtime');?>">
					<?php
				...
				<uib-tab index="5" heading="<?=$this->bbf('smenu_calllimits');?>">
					<?php
