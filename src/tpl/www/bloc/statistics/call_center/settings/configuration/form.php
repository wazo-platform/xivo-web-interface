...
<uib-tabset active="active">
	...
	<uib-tab index="1" heading="<?=$this->bbf('smenu_workweek');?>">
		<?php
	...
	<uib-tab index="2" heading="<?=$this->bbf('smenu_queue');?>">
		<fieldset>
	...
	<uib-tab index="3" heading="<?=$this->bbf('smenu_qos');?>">
		<p class="txt-center">
	...
	<uib-tab index="5" heading="<?=$this->bbf('smenu_permissions');?>">
