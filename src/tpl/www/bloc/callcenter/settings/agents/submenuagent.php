...
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOS<a href=E.  See the
...
<div class="sb-smenu">
	<ul class="nav nav-tabs" role="tablist">
		...
		<li id="dwsm-tab-2"	role="presentation">
			<a role="tab" data-toggle="tab" href="#user"><?=$this->bbf('smenu_users');?></a>
		</li>
		<li id="dwsm-tab-3"	role="presentation">
			<a role="tab" data-toggle="tab" href="#queue"><?=$this->bbf('smenu_queues');?></a>
		</li>
		<li id="dwsm-tab-4"	role="presentation">
			<a role="tab" data-toggle="tab" href="#queueskills"><?=$this->bbf('smenu_queueskills');?></a>
		</li>
