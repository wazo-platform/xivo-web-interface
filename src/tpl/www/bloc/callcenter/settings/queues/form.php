...
<uib-tabset active="active">
	...
	<uib-tab index="1" heading="<?=$this->bbf('smenu_announces');?>">
	...
	<uib-tab index="2" heading="<?=$this->bbf('smenu_members');?>">
	...
	<uib-tab index="5" heading="<?=$this->bbf('smenu_advanced');?>">
		...
		<?php
			...
			echo	$form->text(array('desc'	=> $this->bbf('fm_queue_servicelevel'),
				...
				$form->select(array('desc'  => $this->bbf('fm_queue_autopause'),
