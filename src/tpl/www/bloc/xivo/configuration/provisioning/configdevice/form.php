...
<uib-tabset active="active">
	<uib-tab index="0" heading="<?=$this->bbf('smenu_general');?>">
		...
		<div class="col-sm-offset-2 fm-paragraph fm-description">
			<p>
				<label id="lb-userfeatures-description" for="it-userfeatures-description"><?=$this->bbf('fm_userfeatures_description');?>
			</label>
			</p>
	...
	<uib-tab index="1" heading="<?=$this->bbf('smenu_advanced');?>">
		<fieldset class="xivo-fieldset">
