...
$.widget("ui.multiselect", {
  options: {
	...
	_create: function() {
		...
		this.selectedList.height(Math.max(this.element.height()-this.selectedActions.height(),150));
		this.availableList.height(Math.max(this.element.height()-this.availableActions.height(),150));
